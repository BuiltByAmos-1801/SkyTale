...
$featured_post = [
    'id' => 1,
    'title' => 'The Future of Smartphones: AI & Innovation',
    'published_at' => '2025-09-20',
    'excerpt' => 'Discover how AI is changing the smartphone industry...',
...
$other_posts = [
    [
        ...
        'excerpt' => 'A quick guide to the best laptops for students...',
        'content' => 'Full blog post content here...',
        'first_name' => 'Sara',
        'last_name' => 'Khan'
    ],
...
<head>
    ...
    <title>Blog - SkyTale Electronics</title>
    <meta name="description" content="Stay updated with the latest electronics news, product reviews, and tech insights from SkyTale Electronics. Expert reviews and industry updates.">
...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="blog.php" class="nav-link text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-semibold">Blog</a>
            ...
            <div id="mobile-menu" class="md:hidden hidden border-t border-gray-200 dark:border-gray-700 py-4">
                <nav class="flex flex-col space-y-4">
                    ...
                    <a href="blog.php" class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-semibold">Blog</a>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">Tech Blog & Reviews</h1>
            <p class="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Stay updated with the latest electronics news, expert reviews, and tech insights. 
                Discover the best products and make informed decisions.
            </p>
        </div>
        ...
        <div class="mb-16">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="bg-gray-200 dark:bg-gray-700 h-96 lg:h-auto flex items-center justify-center">
                        <div class="text-center">
                            <i class="fas fa-image text-6xl text-gray-400 mb-4"></i>
                            <p class="text-gray-600 dark:text-gray-400">Featured Post Image</p>
                        </div>
                    </div>
                    <div class="p-8 lg:p-12">
                        <div class="flex items-center space-x-4 mb-4">
                            <span class="bg-blue-100 dark:bg-blue-900/30 text-blue-600 px-3 py-1 rounded-full text-sm font-semibold">
                                Featured
                            </span>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                            <?= htmlspecialchars($featured_post['excerpt'] ?: substr(strip_tags($featured_post['content']), 0, 200) . '...') ?>
                        </p>
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 dark:text-white">
                                        <?= htmlspecialchars($featured_post['first_name'] . ' ' . $featured_post['last_name']) ?>
                                    </p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Author</p>
                                </div>
                            </div>
                            <a href="blog-post.php?id=<?= $featured_post['id'] ?>" class="btn btn-primary">
            ...
            <article class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gray-200 dark:bg-gray-700 h-48 flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">Post Image</p>
                    </div>
                </div>
                <div class="p-6">
                    ...
                    <a href="blog-post.php?id=<?= $post['id'] ?>" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold">
        ...
        <div class="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white text-center">
            ...
            <p class="text-xl opacity-90 mb-6 max-w-2xl mx-auto">
                Subscribe to our newsletter and never miss the latest tech news, product reviews, and exclusive deals.
            </p>
            <form class="max-w-md mx-auto flex gap-4">
                <input type="email" placeholder="Enter your email" 
                       class="flex-1 px-4 py-3 rounded-lg text-gray-900 focus:ring-2 focus:ring-white focus:outline-none">
                <button type="submit" class="btn bg-white text-blue-600 hover:bg-gray-100 px-6 py-3">
                    Subscribe
                </button>
            </form>
        </div>
        ...
        <div class="mt-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                    <div class="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-mobile-alt text-blue-600 text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Smartphones</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Latest phone reviews and comparisons</p>
                    <a href="#" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold">
                        View Posts <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Laptops</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Laptop reviews and buying guides</p>
                    <a href="#" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold">
                        View Posts <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Audio</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Headphones and speaker reviews</p>
                    <a href="#" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold">
                        View Posts <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Gaming</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Gaming gear and accessories</p>
                    <a href="#" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold">
                        View Posts <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
